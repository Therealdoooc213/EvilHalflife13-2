...
export const OBSESSED_MECHANICAL_DESCRIPTION
   = multiline`
      ...
      Follow the Voices' beckoning, and keep your target in the city with you, forever.
   `;
...
const Obsessed: Antagonist = {
  ...
  description: [
    multiline`
      Beauty is often misunderstood. Fate even more so. The others, they don't- they don't hear the voices that whisper sense.
