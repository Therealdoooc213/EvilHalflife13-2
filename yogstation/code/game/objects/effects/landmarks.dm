...
/obj/effect/landmark/stationroom/sewer/leftentrance/tenxten
	template_names = list("sewer left_ten_box", "sewer left_ten_zombie1", "sewer left_ten_zombine1", "sewer left_ten_medical", "sewer left_ten_locked", "sewer left_ten_mining", "sewer left_ten_forcefield", "sewer left_ten_radiation", "sewer left_ten_poisoncrab")

/obj/effect/landmark/stationroom/sewer/rightentrance/tenxten
	template_names = list("sewer right_ten_box", "sewer right_ten_flooded", "sewer right_ten_headcrabs", "sewer right_ten_headcrabs2", "sewer right_ten_infested1", "sewer right_ten_infested2", "sewer right_ten_doors", "sewer right_ten_factory")
