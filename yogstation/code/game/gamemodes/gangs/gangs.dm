...
/datum/game_mode/gang
	...
	restricted_jobs = list("Civil Protection Officer", "Warden", "Detective", "AI", "Cyborg","District Administrator", "Labor Lead", "Divisional Lead", "Chief Engineer", "Research Director", "Chief Medical Officer", "Medical Officer", "Synthetic") //Added Medical Officer
	required_players = 35
	required_enemies = 1
