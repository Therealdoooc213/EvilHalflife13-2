...
#define STARTING_PAYCHECKS_MAX 90 // Maximum roundstart money
...
#define MAX_GRANT_CIV 200
#define MAX_GRANT_ENG 200
#define MAX_GRANT_SCI 200
#define MAX_GRANT_SECMEDSRV 200
