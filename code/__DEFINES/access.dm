...
/// Access used for the District Administrator's personal quarters in mapping, the spare ID cabinet, and the antique gun (but only on gamma alert or above).
...
/// Special Ops. District Administrator's display case, Marauder/Seraph mechs, .
