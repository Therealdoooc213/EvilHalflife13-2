...
#define WOUND_DAMAGE_EXPONENT	1.5
...
/// how much blood you can lose per tick per slash max. 6 is a lot of blood for one cut so don't worry about hitting it easily
