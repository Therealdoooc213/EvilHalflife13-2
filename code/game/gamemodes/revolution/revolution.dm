...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Civil Protection Officer", "Overseer", "Detective", "Dispatch", "Cyborg", "District Administrator", "Labor Lead", "Divisional Lead", "Chief Engineer", "Research Director", "Chief Medical Officer", "Shaft Miner", "Mining Medic", "Medical Officer", "Synthetic") //Yogs: Added Medical Officer
