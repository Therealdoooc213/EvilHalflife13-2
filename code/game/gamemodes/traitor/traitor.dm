...
/datum/game_mode/traitor
	...
	protected_jobs = list("Civil Protection Officer", "Warden", "Detective", "Divisional Lead", "District Administrator", "Labor Lead", "Chief Engineer", "Chief Medical Officer", "Research Director", "Medical Officer", "Dispatch", "Cyborg", "Synthetic") //YOGS -  added the hop and medical officer
	required_players = 0
	required_enemies = 1
