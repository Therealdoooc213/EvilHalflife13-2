...
/datum/game_mode/clockwork_cult
	...
	protected_jobs = list("AI", "Cyborg", "Civil Protection Officer", "Warden", "Detective", "Divisional Lead", "District Administrator", "Medical Officer") //Silicons can eventually be converted //Yogs: Added Medical Officer
