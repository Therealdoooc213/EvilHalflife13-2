...
/datum/game_mode/changeling
	...
	protected_jobs = list("Civil Protection Officer", "Overseer", "Detective", "Divisional Lead", "District Administrator", "Labor Lead", "Chief Engineer", "Chief Medical Officer", "Research Director", "Medical Officer") //YOGS - added hop and medical officer
	required_players = 15
	required_enemies = 1
