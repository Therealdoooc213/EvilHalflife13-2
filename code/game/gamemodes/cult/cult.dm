...
/datum/game_mode/cult
	...
	restricted_jobs = list("Chaplain","Dispatch", "Cyborg", "Civil Protection Officer", "Overseer", "Detective", "Divisional Lead", "District Administrator", "Labor Lead", "Research Director", "Chief Engineer", "Chief Medical Officer", "Medical Officer", "Synthetic") //Yogs: Added Medical Officer
	protected_jobs = list()
	required_players = 24
	required_enemies = 4
