...
/obj/item/toy/crayon
	...
	var/static/list/graffiti = list("face","revolution","guy","end","body","cyka","star","poseur tag", "lambda", "born")
	...
	var/static/list/drawings = list("smallbrush","brush","largebrush","splatter","snake","stickman","carp","ghost","disk","fireaxe","toolbox","corgi","cat","toilet","blueprint","bottle","shotgun")
	...
	var/static/list/graffiti_large_h = list("paint")
