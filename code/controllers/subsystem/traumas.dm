...
/datum/controller/subsystem/traumas/Initialize()
	...
	phobia_objs = list("snakes" = typecacheof(list(/obj/item/rod_of_asclepius)),
					  ...
					  "lizards"   = typecacheof(list(/obj/item/toy/plush/lizardplushie)),
				   ...
				   "conspiracies" = typecacheof(list(/obj/item/clothing/under/rank/command/captain, /obj/item/clothing/under/rank/security/head_of_security,
												 ...
												 /obj/item/clothing/under/rank/command/captain/parade, /obj/item/clothing/under/rank/security/head_of_security/hosparademale,
						...
						/obj/item/clothing/under/rank/medical/nursesuit, /obj/item/clothing/under/rank/medical/chief_medical_officer,
	...
	phobia_species = list("skeletons" = typecacheof(list(/datum/species/skeleton)),
						  "conspiracies" = typecacheof(list(/datum/species/abductor)),
						  "the supernatural" = typecacheof(list(/datum/species/golem/clockwork, /datum/species/golem/runic)),
						  "aliens" = typecacheof(list(/datum/species/abductor, /datum/species/jelly))
						 )
