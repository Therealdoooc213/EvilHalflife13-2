...
/datum/component/fixeye/proc/enable_fixeye(mob/living/source, silent = TRUE, forced = TRUE)
	...
	if(!silent)
		source.playsound_local(source, 'sound/effects/fixeye_on.ogg', 25, FALSE, pressure_affected = FALSE)
...
/datum/component/fixeye/proc/disable_fixeye(mob/living/source, silent = TRUE, forced = TRUE)
	...
	if(!silent)
		source.playsound_local(source, 'sound/effects//fixeye_off.ogg', 25, FALSE, pressure_affected = FALSE)
