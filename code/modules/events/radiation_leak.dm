...
/datum/round_event/radiation_leak
	startWhen = 1 // 2 seconds in
	announceWhen	= 10 // 20 seconds in
	endWhen = 150 // 300 seconds / ~5 minutes in
...
/datum/round_event/radiation_leak/announce(fake)
	...
	var/area/halflife/indoors/location_descriptor
	...
	priority_announce("A radiation leak has been detected in [location_descriptor || "an unknown area"]. \
		All crew are to evacuate the affected area. Our [pick("mechanics", "engineers", "scientists", "sensors", "readings")] \
