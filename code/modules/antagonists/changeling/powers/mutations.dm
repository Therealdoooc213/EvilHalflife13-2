...
/obj/item/gun/magic/tentacle/process_chamber(empty_chamber = TRUE, from_firing = TRUE, chamber_next_round = TRUE, atom/shooter = null)
	. = ..()
	if(charges == 0)
		qdel(src)
...
/obj/item/clothing/suit/armor/changeling
	...
	cold_protection = 0
	heat_protection = 0
	allowed = list(/obj/item/tank/internals/emergency_oxygen) // allows ling armor to carry the usual space suit tanks.
