...
/obj/item/gun
	...
	var/spread = 12						//Spread induced by the gun itself. SEE LINE BELOW.
	var/semi_auto_spread = 12			//Equal to the value above by default. The spread that a weapon will have if it is switched to semi-auto from a burst-fire mode.
