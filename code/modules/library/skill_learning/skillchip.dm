/obj/item/skillchip
	name = "skillchip"
	desc = "This biochip integrates with user's brain to enable mastery of specific skill. Consult certified Combine neurosurgeon before use."

	icon = 'icons/obj/circuitry_n_data.dmi'
